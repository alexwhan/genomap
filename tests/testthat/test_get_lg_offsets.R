...
test_that("lg starts are right from map, cross, mpcross, mpInterval and tidy_gen_map", {
  ...
  expect_equal(get_map_coords(m4_int)$lg_start, starts)
...
test_that("lg ends are right from map, cross, mpcross and tidy_gen_map", {
  ...
  expect_equal(get_map_coords(m4_int)$lg_end, ends)
